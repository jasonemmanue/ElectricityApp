...
class MessageBubble extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Align(
      ...
      // --- MODIFICATION ICI : Ajout de ConstrainedBox pour limiter la largeur ---
      child: ConstrainedBox(
        constraints: BoxConstraints(
          maxWidth: MediaQuery.of(context).size.width * 0.75, // Limite à 75% de la largeur
        ),
        child: Container(
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border(left: BorderSide(color: isMe ? Colors.white70 : Colors.blue.shade800, width: 3)),
                    ),
                    child: Text(
                      repliedText!,
                      style: TextStyle(
